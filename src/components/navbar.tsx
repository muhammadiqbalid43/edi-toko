        ...
        <div className="flex justify-between bg-blue-500 p-4">
          ...
          <div className="rounded-lg bg-gray-200 text-gray-500">
            <div className="flex relative">
              ...
              <input
                type="text "
                className="w-full max-w-[160px] bg-white pl-2 text-base rounded-r-lg font-semibold outline-0"
                onChange={(e) => {
              ...
              />
              {products.length > 0 && (
                <div className="absolute z-10 w-full mt-12 p-2 bg-white border border-gray-200 rounded-lg shadow-lg ">
                  <ul>
